...
export default function JobAddComponent() {
  ...
  const handleSubmit = async (e: React.SubmitEvent<HTMLFormElement>) => {
    e.preventDefault();
    try {
      const res = await fetch("/api/superadmin/jobs/add", {
        method: "POST",
    ...
    <div className="min-h-screen bg-slate-100 p-8">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="rounded-3xl bg-linear-to-r from-blue-700 to-indigo-700 p-8 text-white shadow-xl">
          <h1 className="text-4xl font-bold">Create New Job Vacancy</h1>

          <p className="mt-2 text-blue-100">
            Publish a new recruitment opportunity.
          </p>
        </div>
