...
export default function Header() {
  return (
    <header className="w-full p-2 bg-gray-100">
      <div className="xl:w-[80%] mx-auto flex justify-between items-center xl:flex-row flex-col">
        <div className="flex items-center gap-2">
          ...
          <button className="w-10 h-10 flex items-center justify-center rounded-full relative overflow-hidden bg-white shadow-md shadow-gray-200 group transition-all duration-500">
            ...
            <div className="absolute top-full left-0 w-full h-full rounded-full bg-linear-to-bl from-purple-500 via-pink-500 to-yellow-500 z-0 transition-all duration-500 group-hover:top-0"></div>
          </button>
        ...
        <div className="xl:flex hidden items-center">
          <div className="relative inline-block group">
            <span className="px-4 py-2 text-blue-500 rounded-sm font-semibold cursor-pointer transition-all duration-300">
              We&apos;re Hiring
              <ChevronDownIcon className="inline-block ml-1 transition-transform duration-300 group-hover:rotate-180" />
            </span>

            <div
              className="
      absolute left-0 top-full mt-1 w-56
      bg-white border border-gray-200 rounded-lg shadow-lg z-100!
    ...
    "
            >
              <Link href="/login/admin" className="block px-4 py-3 hover:bg-gray-100 border-b border-gray-200">
                Admin Login
              </Link>

              <Link href="/login/branch" className="block px-4 py-3 hover:bg-gray-100 border-t border-gray-200">
                Branch Login
              </Link>
            </div>
          </div>
